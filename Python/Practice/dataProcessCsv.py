...
print()
qTemplate = session.query(tblTemplates).filter(tblTemplates.sTemplateName == "varuntest").first()
...
df = pd.read_csv('data/ALBD_NBK.txt', sep=qTemplate['sFileDelimeter'], header=None,  engine='python', error_bad_lines=False)
